...
// Component for bulk document move
function BulkDocumentMove({
  documents,
  onSubmit,
}: {
  documents: Document[];
  ...
  // We use the first document to show the move dialog
  // but we'll move all documents to the same destination
